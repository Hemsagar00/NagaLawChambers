    ...
    <AnimatedSection className="portavia-section relative aurora-legal" id="practice">
      ...
      <div className="portavia-container">
        ...
        <motion.div
          ...
          className="nlc-practice-grid md:grid md:grid-cols-2 gap-5 md:gap-6 max-w-5xl mx-auto w-full"
        >
          {practiceAreas.map((area) => (
            <motion.div key={area.id} variants={fadeUp} className="min-w-0 w-full">
